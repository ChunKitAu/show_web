...
import com.chunkit.show_web.config.ShiroConfig;
...
public class ShiroSession extends DefaultWebSessionManager {
    ...
    private static Logger log = LoggerFactory.getLogger(ShiroSession.class);
     ...
     * 重写的部分多了一个把获取到的token设置到request的部分。这是因为app调用登陆接口的时候，是没有token的，登陆成功后，
     * 产生了token,我们把它放到request中，返回结
